...
public class Game implements GameInterface {
    ...
    public void addContent() {
        ...
        try{
            ...
            System.out.println("Game Table | Number of Rows: " + rowCount);
            ...
            System.out.println("Game Table | Number of Columns: " + colCount);
            ...
            GameBean eb = new GameBean(productNumber, name, description, price, isFeatured, image);
           /* stmt.executeUpdate("INSERT INTO EVENTS VALUES ('"+productNumber+"', '"+name+"', '"+description+"', '"+price+"', '"+isFeatured+"', '"+image+"') "); */

            String sql = MessageFormat.format("INSERT INTO EVENTS VALUES ({0}, {1}, {2}, {3}, {4}, {5})", productNumber, "'" + name + "'" , "'" + description +
                    "'", isFeatured, "'" + image + "'" , price);
