...
public class SimpleServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("<html><head></head><body><h1>Simple Web Page</h1>");
        ...
        result = theStudents.findStudents(cols, request.getParameter("value"));
        out.println("<table><tr><th> Account</th><th>First Name</th><th>Last Name </th><th>Email</th><th>IP Address</th>");

        for (Individual i: result) {
            out.println("<tr><td>" + i.getAccountNumber() + "</td> <td>" + i.getFname() + "</td><td> " + i.getLname() + "</td><td>"+ i.getEmail() +"</td><td>" + i.getIpAddress() + "</tr>" );
        }
